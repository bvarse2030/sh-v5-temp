...
const FooterV1 = () => {
  ...
  const linkStye = 'hover-underline-animation cursor-pointer';
  const mobileLayoutTitleStyle = 'text-xl font-semibold  border-b border-slate-200 mt-4';
  const TabletLayout = () => (
      ...
      <div className="flex w-full flex-col">
        <div className="grid w-full grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
          <div className="py-4">
            <div className="grid w-full grid-cols-2">
              <div className="flex w-full flex-col gap-2 ">
                <h2 className="mb-3 text-[18px] font-semibold ">Categories</h2>
          ...
          <div className="py-4">
            <div className="grid w-full grid-cols-2">
              <div className="flex w-full flex-col gap-2  ">
                <h2 className="mb-3 text-[18px] font-semibold ">Get to knows us</h2>
              ...
              <div className="flex w-full flex-col gap-2  ">
                <h2 className="mb-3 text-[18px] font-semibold ">For Consumers</h2>
          ...
          <div className="py-4">
            <div className="grid w-full lg:grid-cols-2">
              <div className="flex w-full flex-col gap-2  ">
                <h2 className="mb-3 text-[18px] font-semibold ">Become a Shopper</h2>
              ...
              <div className="flex w-full flex-col gap-2  ">
                <h2 className="mb-3 text-[18px] font-semibold ">Fresh cart Programs</h2>
  ...
  return (
    <section className="border-t px-2 pb-2 pt-12">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex w-full flex-col items-start justify-between gap-4 border-t py-4 md:flex-row md:items-center">
          <div className="flex h-auto items-center justify-start gap-4">
            <h2 className="text-sm font-semibold ">Payment Partners</h2>
          ...
          <div className="flex h-auto items-center justify-end gap-4">
            <h2 className="text-sm font-semibold ">Get deliveries with FreshCart</h2>
        ...
        <div className="flex w-full flex-col items-start justify-between gap-4 border-t py-4 text-xs md:flex-row md:items-center">
          ...
          <div className="flex h-auto items-center justify-end gap-4">
            <h2 className="text-sm font-semibold ">Follow us on</h2>
            <span className="cursor-pointer rounded-lg border p-2">
