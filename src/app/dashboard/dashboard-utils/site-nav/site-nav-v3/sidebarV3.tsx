...
const SidebarV3 = ({ toggle, handleToggle, toggleButton = false }: { toggleButton?: boolean; toggle: boolean; handleToggle: () => void }) => {
  return (
    <div className=" md:border-b md:pb-[60px] ">
      <div className="relative text-slate-600">
        {!toggleButton && (
          <>
            {toggle ? (
              <div onClick={handleToggle} className="top-0 left-0 block w-[253px] md:absolute ">
                <h3 className="flex w-full cursor-pointer items-center justify-start gap-4   py-4 text-[.8rem]">
                  <span className="ml-4">
                    <CgArrowLongLeft />
                  </span>
                  Hide
              ...
              <div onClick={handleToggle} className="top-0 left-0 block w-[63px] md:absolute ">
                <h3 className="flex w-full cursor-pointer items-center justify-center   pb-[17px] pt-[18px]">
                  <span title="View">
                    <CgArrowLongRight />
                  </span>
                </h3>
        ...
        <ScrollArea className="md:h-[calc(100vh_-_122px)] md:top-[50px] pt-2 border-t-1">
          {toggle ? (
            <div className="ml-3">
